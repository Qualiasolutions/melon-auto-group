...
INSERT INTO vehicles (
  make, model, year, mileage, price, currency, condition, category,
  engine_type, transmission, horsepower, location, country, vin,
  images, description, available, featured, specifications
) VALUES
(
  'Mercedes-Benz', 'Actros 1851 LS', 2020, 185000, 75000, 'EUR', 'used', 'semi-truck',
  'diesel', 'automated-manual', 510, 'Berlin', 'Germany', 'WDB9634161L123456',
  ARRAY['https://via.placeholder.com/800x600?text=Mercedes+Actros'],
  'Excellent condition Mercedes-Benz Actros with full service history. Euro 6 compliant.',
  true, true,
  '{"axleConfiguration": "4x2", "gvw": 18000, "engineCapacity": 12.8, "emissionStandard": "Euro 6", "cabType": "Sleeper"}'::jsonb
),
(
  'Scania', 'R 500', 2019, 320000, 68000, 'EUR', 'used', 'semi-truck',
  'diesel', 'automated-manual', 500, 'Rotterdam', 'Netherlands', 'YS2R4X20005123456',
  ARRAY['https://via.placeholder.com/800x600?text=Scania+R500'],
  'Powerful Scania R 500 in great working condition. Well maintained.',
  true, true,
  '{"axleConfiguration": "6x4", "gvw": 26000, "engineCapacity": 16.4, "emissionStandard": "Euro 6"}'::jsonb
),
(
  'Volvo', 'FH16 750', 2021, 95000, 95000, 'EUR', 'certified', 'semi-truck',
  'diesel', 'automated-manual', 750, 'Stockholm', 'Sweden', 'YV2AG40B5MA123456',
  ARRAY['https://via.placeholder.com/800x600?text=Volvo+FH16'],
  'Top of the line Volvo FH16 with 750hp. Like new condition with warranty.',
  true, true,
  '{"axleConfiguration": "6x4", "gvw": 32000, "engineCapacity": 16.1, "emissionStandard": "Euro 6", "cabType": "Globetrotter XL"}'::jsonb
);
